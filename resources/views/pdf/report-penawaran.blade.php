...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .data-table .col-money { text-align: right; }
...
<body>
    ...
    <table class="meta-table">
        ...
        <tr><td class="label">Total Data</td><td class="sep">:</td><td>{{ count($quotations) }} penawaran</td></tr>
    </table>
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="col-center">{{ strtoupper($q->type) }}</td>
                <td class="col-center">{{ ['draft' => 'Draft', 'approve' => 'Diterima', 'reject' => 'Ditolak'][$q->status] ?? ucfirst($q->status) }}</td>
                <td class="col-center">{{ $q->date->format('d/m/Y') }}</td>
                <td class="col-money">Rp {{ number_format($q->total_amount, 0, ',', '.') }}</td>
            </tr>
            @empty
        ...
        <tfoot>
            <tr style="background-color: #f5f5f5;">
                <td colspan="7" style="text-align: right; padding: 7px 5px; font-weight: bold;">Grand Total</td>
                <td class="col-money" style="font-weight: bold;">Rp {{ number_format($quotations->sum('total_amount'), 0, ',', '.') }}</td>
            </tr>
        </tfoot>
    </table>
